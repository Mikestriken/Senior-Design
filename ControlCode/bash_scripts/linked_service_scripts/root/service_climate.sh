...
# This script will be ran by the sd_climate.service.
# 
# This script runs the climate_main python script found in the
...
../venv/bin/python -m operations.climate_main