...
##############################################################################
#                          Run Spot Operation Control Code
# This script manually runs the spot_interaction python script found in the
...
sudo ../venv/bin/python -m operations.spot_interaction $@