...
##############################################################################
#                        Enable linux .service files
# This script enables all the linux services that this code repository
# creates. This means that on startup, the control code will be
